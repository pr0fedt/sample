...
declare class Buffer {
  ...
  static alloc(size: number, fill?: any, encoding?: buffer$Encoding): Buffer;
  static from(str: string, encoding?: buffer$Encoding): Buffer;
...
declare function setTimeout(callback: () => mixed, ms: number): Timeout;
declare function setInterval(callback: () => mixed, ms: number): Interval;
